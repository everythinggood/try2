...
export function renderModel(canvas, THREE) {
  ...
  function init() {
    ...
    // https://litemall.obs.cn-south-1.myhwclouds.com/test/model.glb
    loader.load('https://litemall.obs.cn-south-1.myhwclouds.com/test/model.glb', function (gltf) {
      console.log("gltf:", gltf)
      model = gltf.scene;
      model.traverse(function (child) {
        if (child.isMesh) {
          console.log("model-child:",child)
